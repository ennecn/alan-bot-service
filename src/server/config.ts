...
export function loadConfig(): AlanConfig {
  return {
    ...
    embedding_url: env('ALAN_EMBEDDING_URL', 'http://127.0.0.1:8098'),
    embedding_api_key: process.env.ALAN_EMBEDDING_API_KEY || undefined,
    embedding_model: process.env.ALAN_EMBEDDING_MODEL || undefined,
